...
- 1 admin
- 5 employees (2 per domain: 2 team leads + 3 regular mentors, DA + DS + Soft Skill)
- 8 interns (4 DA + 4 DS)
...
DEPT_CODES = {"Data Analytics": "da", "Data Science": "ds", "Soft Skill": "ss"}

DA_EMP_NAMES = ["Asif", "Mubashira"]
DS_EMP_NAMES = ["Ajmal", "Sneha"]
SS_EMP_NAMES = ["Amina"]
...
def seed_employees():
    domain_configs = [
        ...
        ("Soft Skill", SOFT_SKILLS, SS_EMP_NAMES, "Senior Soft Skill Mentor", "Soft Skill Mentor"),
